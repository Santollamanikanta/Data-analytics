...
export const NAV_ITEMS: { id: AnalyticsView; label: string; icon: React.ReactNode }[] = [
  {
    id: 'home',
    label: 'Dashboard',
  ...
  },
  {
    id: 'market',
    label: 'Market',
    icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2.5 21h19"/><path d="M7 21v-4a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v4"/><path d="M10 3v2.34a2 2 0 0 1-2 2H6a2 2 0 0 0-2 2v1"/><path d="M14 12v-1a2 2 0 0 0-2-2h-2a2 2 0 0 1-2-2V4.66a2 2 0 0 1 2-2.34V1"/></svg>,
  },
  {
    id: 'financial',
    label: 'Financials',
